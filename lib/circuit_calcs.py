...
def average_contiguous_columns(arr): # Unneeded if each phi_T has a precise chi and current value
    """
...
# Find sign changes and interpolate (or just choose smallest difference)
    ...
    # while (sign changes occurs within xi block in positive direction):
        ...
        # need to look at an identical matrix with the ind_phase + 2pi and look for changes
